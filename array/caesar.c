...
int main(int argc, char *argv[])
{
    ...
    printf("plaintext: ");
    fgets(plaintext,10000,stdin);                        //get plaintext to encipher  from user
    ...
    for (int i = 0; i < plaintext_length; i++)      //iterate through the length of plaintext
    {
        ...
        {
            printf("%c", (((plaintext[i] - 97) + key) % 26) + 97);            //enchiper the text with the calculation
        }
